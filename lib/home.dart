...
List<Widget> _tiles = [
  _Example0Tile(Color(0xff65DBB7),Icons.receipt,"Mpesa Receipts"),
  _Example0Tile(Color(0xff799FEB),Icons.add_box,"Add Item"),
  _Example0Tile(Color(0xffE35672),Icons.move_to_inbox,"Change Item"),
  _Example0Tile(Color(0xff967AEC),Icons.bubble_chart,"Statistics"),
  _Example0Tile(Color(0xffE89C5B),Icons.hotel,"Accomodation status")
];
...
Widget _Example0Tile (Color background, IconData icondata, String text)
{
  return new Card(
    color: background,
